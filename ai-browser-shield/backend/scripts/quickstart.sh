#!/bin/bash
# Quick Start Script for Email ML Model
# ======================================
...
python3 generate_test_dataset.py 500 phishing_test_dataset.csv
...
python3 email_ml_model.py phishing_test_dataset.csv
