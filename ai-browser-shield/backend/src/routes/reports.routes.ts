...
router.post('/', apiKeyAuth, optionalRequestSignature, createRateLimiter({ endpoint: 'reports_ip', limit: 5, windowMs: 60 * 60 * 1000 }), validateBody(reportSchema), createReportController);
